	<?php if($page->status_slider == 'active') : ?>
	<!-- Slide1 -->
	<section class="slide1">
		<div class="wrap-slick1">
			<div class="slick1">
				...
				<div class="item-slick1 item1-slick1" style="background-image: url(<?=base_url('uploads/slider/'.$x->slider_banner)?>">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						<!-- <h4 class="caption1-slide1 t-center animated visible-false m-b-15" data-appear="fadeInDown">
							<?=$x->slider_body?>
						</h4>
	...
	<?php if($page->status_title_1 == 'active') : ?>
				...
				<?php foreach($popular as $p) : ?>
					<div class="col-sm-4">
						...
						<div class="block1 hov-img-zoom pos-relative m-b-30">
							<img src="<?=base_url('uploads/product/'.$p->product_img)?>" alt="IMG-BENNER">
	...
	<?php if($page->status_title_2 == 'active') : ?>
	...
	<?php if($page->status_title_4 == 'active') : ?>
	...
	<?php if($page->status_title_5 == 'active') : ?>
