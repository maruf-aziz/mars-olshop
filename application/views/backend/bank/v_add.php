...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo form_open_multipart(base_url().'admin/bank/add',array('class' => 'form-horizontal')); ?>
                ...
                <span class="help-block"><i><small><?=form_error('bank_name')?></small></i></span>
						...
						<div class="form-group <?=form_error('bank_user') ? 'has-error' : null?>">
							...
							<div class="col-sm-4">
                <input type="text" class="form-control" name="bank_user" value="<?=set_value('bank_user')?>">
                <span class="help-block"><i><small><?=form_error('bank_user')?></small></i></span>
						...
						<div class="form-group <?=form_error('bank_number') ? 'has-error' : null?>">
							...
							<div class="col-sm-4">
                <input type="text" class="form-control" name="bank_number" value="<?=set_value('bank_number')?>">
